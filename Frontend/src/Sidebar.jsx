...
function Sidebar(){
    ...
    // 1. डेटाबेस से सारे थ्रेड्स (चैट लिस्ट) लोड करने का फंक्शन
    const getallThreads = async () => {
    ...
    // 2. जब भी कोई नई चैट शुरू हो या थ्रेड बदले, लिस्ट को अपडेट करें
    useEffect(() => {
        getallThreads();
    }, [currThreadId]);
    ...
    // 3. किसी पुरानी चैट पर क्लिक करने पर उसे स्क्रीन पर खोलने के लिए
    const changeThread = async (newThreadId) => {
        setCurrThreadId(newThreadId);
        const token = localStorage.getItem("token");
        try {
    ...
    // 4. किसी थ्रेड को डिलीट करने के लिए
    const deleteThread = async (threadId) => {
        const token = localStorage.getItem("token");
        try {
